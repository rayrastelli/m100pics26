    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
      <div className="w-full max-w-sm px-6">
        <div className="mb-10 text-center">
          <img src={logoUrl} alt="Marching Hundred" className="w-20 h-20 object-contain mb-3 mx-auto" />
          <h1 className="text-2xl font-semibold text-zinc-100 tracking-tight">Band Pics</h1>
          <p className="mt-1 text-sm text-zinc-400">Marching Hundred photo library</p>
        </div>
